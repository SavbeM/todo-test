import type { DeleteProps } from "../types/todo"
import { useAppDispatch } from "../app/hooks"
import { removeTodo } from "../app/slices/todoSlice"
...
export const Delete = ({id} : DeleteProps) => {
  ...
  return (
    <svg onClick={() => handleDelete()} className="text-[#CDCDCD] cursor-pointer hover:text-[#E50000]" stroke="currentColor" width="18" height="18"
      ...
      />
      <path d="M14.625 3.75H3.375" stroke="currentColor" />
      <path
        d="M7.5 2.25C7.5 1.83579 7.83577 1.5 8.25 1.5H9.75C10.1642 1.5 10.5 1.83579 10.5 2.25V3.75H7.5V2.25Z"
        stroke="currentColor"
      />
      <path d="M10.5 9V12.75" stroke="currentColor" />
      <path d="M7.5 9V12.75" stroke="currentColor" />
    </svg>
  )
}